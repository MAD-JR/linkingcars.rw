  ...
  <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
    ...
    if($query->rowCount() > 0)
    {
      ...
      {  
        ...
        { 
          ?>
          <a class="navbar-brand brand-logo " href="dashboard.php"><img class="img-avatar" style="height: 50px; width: auto;" src="assets/img/avatars/avatar15.jpg" alt=""></a>
        <a class="navbar-brand brand-logo-mini" href="dashboard.php"><img style="height: 30px; width: auto;" src="assets/img/avatars/avatar15.jpg" alt="logo" /></a>
          <?php 
        } else { ?>
          <a class="navbar-brand brand-logo " href="dashboard.php"><img class="img-avatar" style="height: 50px; width: auto;" src="companyimages/<?php  echo $row->companylogo;?>" alt=""></a>
        <a class="navbar-brand brand-logo-mini" href="dashboard.php"><img style="height: 30px; width: auto;" src="companyimages/<?php  echo $row->companylogo;?>" alt="logo" /></a>
          <?php 
        } ?>
        <?php
      }
