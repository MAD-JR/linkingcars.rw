...
<head>
  <meta charset="utf-8">
  <title>Linking |Car Details</title>
...
<body id="body"> 
 ...
 <section id="innerBanner"> 
  <div class="inner-content">
    <h2><span  style="color: skyblue;">ABOUT CAR</span><br>We provide high quality and well serviced cars </h2>
    <div> 
    </div>
  </div> 
</section><!-- #Page Banner -->
          ...
          if($query->rowCount() > 0)
          {
            ...
            {  
              ...
              <div class="owl-carousel clients-carousel">
                <a href="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" class="portfolio-popup">
                <img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" alt="<?php echo htmlentities($result->Vimage1);?>" style="height: 150px; width:300px;"></a>
                <a href="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage2);?>" class="portfolio-popup">
                <img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage2);?>" alt="" style="height: 150px; width: 300px;"></a>
                <a href="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage3);?>" class="portfolio-popup">
                <img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage3);?>" alt="" style="height: 150px; width: 300px;"></a>
                <a href="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage4);?>" class="portfolio-popup">
                <img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage4);?>" alt="" style="height: 150px; width: 300px;"></a>
              </div>
            </div>
          </section><!-- #clients -->
            ...
            <div class="sidebar_widget">
              ...
              <form method="post">
                <div class="form-group">
                  <label>Name:</label>
                  <input type="text" class="form-control" name="fromdate" placeholder="Name" required>
                </div>
                <div class="form-group">
                  <label>Email Address:</label>
                  <input type="email" class="form-control" name="fromdate" placeholder="Email" required>
                </div>
                <div class="form-group">
              ...
              { 
                ...
                <div class="col-md-3 grid_listing">
                  <div class="product-listing-m gray-bg">
                    <div class="product-listing-img"> <a href="car_details.php?vhid=<?php echo htmlentities($result->id);?>"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" class="img-responsive" style="height: 200px; width: auto;" alt="image" /> </a>
                    </div>
