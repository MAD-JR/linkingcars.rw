...
<head>
  <meta charset="utf-8">
  <title>Linking | Car Rental</title>
...
<body id="body"> 
 ...
 <section id="innerBanner"> 
  <div class="inner-content">
    <h2><span  style="color: skyblue;">Our Fleet</span><br>We provide high quality cars!</h2>
    <div> 
    </div>
  </div> 
</section><!-- #Page Banner -->
                ...
                if($query->rowCount() > 0)
                {
                  ...
                  {  
                    ...
                    <div class="product-listing-m gray-bg">
                      <div class="product-listing-img"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" class="img-responsive" alt="Image" style="height: 200px; width: auto;" /> </a> 
                      </div>
                    ...
                    <ul>
                      ...
                      if($query->rowCount() > 0)
                      {
                        ...
                        {  
                          ...
                          <li class="gray-bg">
                            <div class="recent_post_img"> <a href="car_details.php?vhid=<?php echo htmlentities($result->id);?>"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" alt="image"></a> </div>
                            <div class="recent_post_title"> <a href="car_details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></a>
